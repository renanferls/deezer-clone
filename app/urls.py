...
from .views import (CustomSearch, album_ListCreate, album_ReadUpdateDelete,
                    artist_ListCreate, artist_ReadUpdateDelete,
                    genre_ListCreate, genre_ReadUpdateDelete, queryAlbum,
                    queryArtist, track_ListCreate, track_ReadUpdateDelete)
...
urlpatterns = [
    ...
    path('process/album/<pk>', queryAlbum.as_view()),
    path('process/artist/<pk>', queryArtist.as_view()),
